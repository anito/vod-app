...
<Component extended>
	...
	<div class="container flex flex-col self-center">
		...
		<h2>Registration</h2>
		<p>
			To access certain services offered by our application, we may
			require that you create an account with us or provide personal
			information to complete the creation of an account. You are
			responsible for maintaining the confidentiality of your user
			identification, password, account details. We will only use your
			name and email from Facebook as a part of the verification and which
			will available for the public user to contact you for taking your
			product. You agree to accept this responsibility and ensure your
		...
		<p>
			You agree, understand and acknowledge that this is an online
			platform that enables you to connect to donated product at any time
			from any location. You further agree and acknowledge that we are
			only a facilitator. You agree not to hold Daani responsible for the
		...
		<h2>No warranties</h2>
		<p>
			Daani expresses no representations or warranties, of any kind
			related to this application or the materials contained on this
			application. Also, nothing contained on this Website shall be
		...
		<p>
			...
			rights including the copyright, to Your Content None of the
			materials included in Your Content are unlawful, defamatory,
			libelous, obscene or pornographic, promotes racism or hatred based
			on age, gender, race, religion, caste, class Use of Your Content
			will not violate any legal rights (privacy, intellectual property,
			etc) of any third party You are solely responsible and accountable
			for Your Content Moreover, you agree not to post or list any
			information: That is related to the sale of any illegal,
			counterfeit, stolen goods and/or services Containing virus, spam,
			pyramid schemes or any similar forms Related to goods / or services
			that are prohibited by laws &amp; regulation of Federal Democratic
			Republic of Nepal
		</p>
