              ...
              <div class="item">
                ...
                {:else}
                  <Button disabled style="min-width: 100%;">
                    <Label class="token-button-label">Account gesperrt</Label>
                  </Button>
                {/if}
              </div>
            </div>
...
<Dialog
  ...
  <Content id="info-content">
    <i class="material-icons mdc-button__icon">warning</i>
    <div class="item">
      Mit dieser Aktion wird der bisherige Token unbrauchbar gemacht. Besitzer
      des alten Tokens haben keine Möglichkeit mehr sich über diesen anzumelden!
    </div>
    <div class="item">
      Denken Sie daran, Benutzer
      <strong>{currentUser.name}</strong>
      über neuen Token zu informieren.<br />Ein konventioneller Login über
      "Benutzername/Passwort" wird weiterhin mit den bisherigen
      Anmeldeinformationen möglich sein.
    </div>
  </Content>
  <Actions>
    <Button action="none">
