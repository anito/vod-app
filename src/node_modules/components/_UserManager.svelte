    ...
    <div class="flex flex-auto">
      ...
      {#if currentUser && isAdmin}
        <div class="token-factory">
          <div class="main-info">
            <div class="button-group token-action-buttons flex mt-1">
              <Group>
                <Button
                  class="magic-link"
                  variant="raised"
                ...
                <Button
                  disabled={currentUser.group.name === 'Administrator' || !token_id}
            ...
            <div class="item">
              {#if token_id}
                <Button
                  ...
                  variant="outlined"
                  style="min-width: 100%;"
                  href="http://{$page.host}/login?token={token_value}"
                ...
                <details>
                  ...
                  <p>
                    Testen Sie den Magic Link indem Sie ihm durch anklicken
                    folgen. Dadurch werden Sie auf dieser Seite abgemeldet und
                    auf einer neuen Seite automatisch als Benutzer
                    <strong>{currentUser.name}</strong>
                    angemeldet. Um anschliessend weiter zu arbeiten, schliessen
                    Sie am Besten das neue Fenster und kommen zurück auf diese
                    Seite. Da Sie abgemelddet wurden, müssen Sie sich hier nun
                    erneut an Ihrem Account anmelden.
                  </p>
                </details>
              {:else}
                ...
                <ul>
                  <li>
                    ...
                    <a
                      ...
                      per Email an
                      {currentUser.name}</a><br />oder
                  </li>
                  <li>
                    Kopieren Sie die Adresse des Links um sie z.B. später per
                    Email zu verschicken. Gehen Sie dabei wie folgt vor:
                    Rechtsklick auf den
                    <i>Magic Link</i>
                    -&gt;
                    <i>Adresse des Links kopieren</i>
                  </li>
                </ul>
              </div>
            {/if}
