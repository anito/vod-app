            ...
            <div class="user-items">
              ...
              {#if selectedMode === "add" || selectedMode === "edit"}
                ...
                <div class="item">
                  ...
                  >
                    <span slot="icon"
                      ><SelectIcon class="material-icons">
                        contact_page
                      </SelectIcon></span
                    >
                    <Option value="" />
            ...
            <div class="main-info">
              <div class="button-group token-action-buttons flex mt-1 mb-3">
                <Group>
                  ...
                  <Button
                    disabled={currentUser.group.name === "Administrator" ||
                      !token_id ||
                ...
                <div class="item">
                  ...
                  <details>
                    ...
                    <p>
                      ...
                      <i>Magic Link</i>
                      klicken. Sie werden von Ihrem Account abgemeldet und automatisch
                      als
...
>
  ...
  <Content id="info-content">
    <div class="item">
      <i class="material-icons mdc-button__icon">info</i>
      Ein Token ist eine kryptische Zeichenkette mit verschlüsselten (Anmelde-) Informationen.<br
      />Beispiel:
    ...
    <div class="item">
      ...
      <details>
        ...
        <p>
          ...
          Um Ihren KlientInnen Zugang zu ihrem Account zu ermöglichen, müssen Sie
          nur noch den Link an sie aushändigen.
        </p>
      </details>
      <details>
    ...
    <div class="item">
      ...
      Benutzen Sie den Button
      <i>{removeTokenText}</i>
      um die Anmeldung über diesen Link zu verhindern. Sie können jederzeit einen
      neuen Token generieren.
    </div>
    <div class="item">
      <i class="material-icons mdc-button__icon">warning</i>
      Jeder im Besitz dieses Links verfügt automatisch über Zugriff auf gespeicherte
      Benutzerdaten, einschliesslich gebuchter Inhalte. Gehen Sie daher äusserst
      achtsam mit dem Token bzw. Link um und geben Sie ihn nicht an Dritte weiter.
    </div>
    <div class="item">
