            ...
            <div class="button-group token-action-buttons flex mt-1 mb-3">
              <Group>
                <Button
                  ...
                  <Label class="token-button-label">{generateTokenText}</Label>
                </Button>
                <Button
            ...
            {#if token}
              <div class="item">
                ...
                <details>
                  ...
                  <p>
                    Je nach Konfiguration Ihres Browsers, startet bei Anklicken
                    spezieller Email-Links ein Email Programm. Falls dies bei
                    Ihnen nicht der Fall sein sollte, lesen Sie den nächsten
                    Punkt.
                    <br />
