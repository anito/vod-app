...
<style>
  ...
  .magic-link-group
    > :global(.smui-button__group a:nth-child(1), .smui-button__group
      > a:nth-child(1):hover) {
    flex: 0 1 100px;
    max-width: 100px;
  }
...
<Dialog
  ...
  <Content id="info-content">
    <div class="item">
      <i class="material-icons mdc-button__icon">info</i>
      Ein Token lediglich eine kryptisch aussehende Zeichenkette die
      verschlüsselte Informationen beinhaltet. Verwendung findet er u.a. bei der
      Anmeldung an Nutzeraccounts. Hier ein Beispiel:
      <pre>
    ...
    <div class="item">
      <details>
        ...
        <p>
          Da der Token Anmeldeinformationen speichert, kann man aus ihm ganz
          einfach einen Link erstellen. Dieser führt in den meissten Fällen zu
          einer Anmeldeseite. Dort werden die Informationen entschlüsselt und
          für den Anmeldeprozess verwendet. Das fehlerbehaftete Eintippen von
          Benutzernamen/Passwort entfällt und es kann sofort losgelegt werden.
        </p>
      </details>
      <details>
