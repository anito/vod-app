                ...
                <div
                  ...
                  <Group style="max-width: 100%;">
                    <Button
                      ...
                      variant="outlined"
                      href={magicLink}
                      on:click={() => setTimeout(() => (location.href = 'login'), 100)}
                      target="_blank">
              ...
              <div class="item">
                ...
                <details>
                  ...
                  <p>
                    ...
                    <i>Magic Link</i>
                    klicken. Sie werden daraufhin auf dieser Seite abgemeldet
                    und auf einer neuen Seite automatisch als Benutzer
                    <strong>{currentUser.name}</strong>
                    angemeldet. Um anschliessend weiter zu arbeiten, können Sie
                    das Fenster wieder schliessen und kehren zurück auf diese
                    Seite. Da Sie abgemelddet wurden, müssen Sie sich hier nun
                    erneut anmelden.
                  </p>
                </details>
                <details>
                  ...
                  <p>
                    Versuchen Sie direkt über den Browser eine Email zu
                    verschicken. Sollte Ihr System entsprechend konfiguriert
                    sein, wird sich ein Email Programm öffnen. Klicken Sie hier
                    um es zu versuchen:
                    <a
                ...
                <details>
                  ...
                  <p>
                    ...
                    <i>Kopieren</i>
                    um den Link in Ihre Zwischenablage zu kopieren. Sie können
                    den Link nun bequem in eine Email einfügen (<i>Strg-V</i>
                    auf Ihrer Tastatur) und weiterleiten.
                  </p>
                </details>
              </div>
            {/if}
...
<Dialog
  ...
  <DialogTitle id="info-title">Wie funktioniert ein Token?</DialogTitle>
  <Content id="info-content">
    <div class="item">
      ...
      <i>magischen Link</i>
      zu erzeugen. Um Ihren KlientInnen Zugang zu ihrem Account zu ermöglichen,
      sollten Sie anschliessend den Link an sie aushändigen.<br />Mit diesem
      Link gestatten Sie es Ihren KlientInnen, sich auf schnelle und
      unkomplizierte Art und Weise einzuloggen. Das sonst übliche und
      fehlerbehaftete Eintippen von Benutzername/Passwort entfällt und es kann
