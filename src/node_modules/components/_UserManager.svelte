...
<Dialog
  ...
  <Content id="info-content">
    <div class="item">
      <i class="material-icons mdc-button__icon">info</i>
      Ein Token ist eine kryptisch aussehende Zeichenkette die verschlüsselte
      Informationen beinhaltet. Verwendung findet er u.a. bei der Anmeldung an
      Nutzeraccounts. Hier ein Beispiel:
      <pre>
