<script>
  ...
  $: ((user) => {
    ...
    activeLabel = (active && $_('text.activate-user')) || $_('text.deactivate-user');
  })(currentUser);
  ...
  async function submit(event) {
    ...
    switch (mode) {
      ...
      case 'activate':
        ...
        break;
      case 'del':
        if (!confirm('messages.permanently-remove-user', { values: { name } })) return;
            ...
            <div class="user-items">
              ...
              {#if selectedMode === 'add' || selectedMode === 'edit'}
                <div class="item">
                  ...
                  <HelperText validationMsg>{$_('text.invalid-email')}</HelperText>
                </div>
                <div class="item">
                  <Textfield
                    withLeadingIcon
              ...
              {#if selectedMode === 'add' || selectedMode === 'pass'}
                <div class="item">
                  ...
                  <HelperText id="helper-password">{$_('text.password-hint')}</HelperText>
                </div>
                <div class="item">
                  <Textfield
                    withLeadingIcon
              ...
              <div class="additional-info">
                {#if token}
                  <div class="item">
                    ...
                    <details>
                      <summary>{$_('summary.send-link.header')}</summary>
                      <p>
                        {@html $_('summary.send-link.text')}
                      </p>
                      <p>
                        <a
                          href="mailto:{currentUser.email}?subject={$_(
                            'text.mail-subject'
                          )}=http://{$page.host}/login?token={tokenVal}&cc={user.email}"
                          target="_blank"
                        >
                          {$_('text.viaEmailTo', { values: { name: currentUser.name } })}</a
                        >
                      </p>
                    </details>
                    <details>
