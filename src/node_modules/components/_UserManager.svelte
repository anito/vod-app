    ...
    <div class="item">
      ...
      <details>
        ...
        <p>
          ...
          einen neuen Token. Alle zuvor generierten Token werden dadurch
          unbrauchbar.
        </p>
        <p>
          Verwenden Sie den Button
          <i>"{removeTokenText}"</i>, um das Konto zu sperren. Alternativ können
          Sie auch
          <i>Deactivate User</i>
          anklicken. Beachten Sie hier jedoch, dass dann auch das Einloggen über
          Email/Passwort nicht mehr möglich ist.
        </p>
      </details>
    </div>
    <div class="item">
