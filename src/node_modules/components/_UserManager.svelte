  ...
  <Content id="info-content">
    ...
    <div class="item">
      <details>
        ...
        <p>
          Der Token wird als Parameter an einen Link "angehängt". Kann der
          Zielserver den Token entschlüsseln und einem vorhandenen Benutzer
          zuordnen, wird dieser Benutzer angemeldet. Das übliche fehlerbehaftete
          Eintippen von Benutzernamen/Passwort entfällt also und es kann sofort
          losgelegt werden.
        </p>
      </details>
      <details>
    ...
    <div class="item">
      ...
      neuer Token angefordert wird, hat dieser eine Gültigkeit von 30 Tagen.
    </div>
  </Content>
  <Actions>
