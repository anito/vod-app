<script>
  ...
  import List, { Item, Text, Graphic, Separator, Subheader, Meta } from '@smui/list/styled';
  import Fab, { Label, Icon as FabIcon } from '@smui/fab/styled';
  import Dialog, { Title as DialogTitle, Content as DialogContent, Actions, InitialFocus } from '@smui/dialog/styled';
  ...
  $: currentTemplate = $templates.find((tmpl) => tmpl.slug === someTemplate) || null;
              ...
              >
                ...
                {#if !template.protected}
                  {#if editor.id === template.id}
                    <Meta on:click={(e) => cancelEditable(e)} class="material-icons-outlined edit">cancel</Meta>
                    <Meta on:click={(e) => saveEditable(e)} class="material-icons-outlined edit">check_circle</Meta>
                  {:else}
                    <Meta on:click={(e) => makeEditable(e, template.id)} class="material-icons-outlined edit">edit</Meta
                    >
                  {/if}
                {/if}
