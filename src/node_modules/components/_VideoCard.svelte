<script>
	...
	function getCachedImage(id) {
		let res = getMedia('IMAGE', id, user, {width:100, height:100, square: 1});
		return res;
	}
...
<Card class="flex content-between card {className}" style="width: var(--player-w);">
	<PrimaryAction>
		...
		<Content class="mdc-typography--body2">
			...
			<div class="opacity-25 text-xs text-inherit" class:opacity-25={!video.image_id}>
