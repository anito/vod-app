<script>
  ...
  import Card, {
    ...
    ActionButtons,
    ActionIcons,
  } from "@smui/packages/card";
  import Button, { Label } from "@smui/packages/button";
  import IconButton, { Icon } from "@smui/packages/icon-button";
  import Menu from "@smui/packages/menu";
  import MenuSurface, { Anchor } from "@smui/packages/menu-surface";
  import ImageList, {
    Item as ImageListItem,
    ImageAspectContainer,
    Image,
  } from "@smui/packages/image-list";
  import List, {
    Item,
    Separator,
    Text,
      ...
      {:else}
        <div class="text-xs">
          ...
          <div class="flex justify-between">
            <Label
              style="align-self: center; padding-right: 10px; max-width: 45%;">
