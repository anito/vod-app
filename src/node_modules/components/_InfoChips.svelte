    ...
    <div class:staggered>
      <Set class="info {className}" {chips} let:chip>
        <Chip
          ...
          {chip}
          class="{chip.flag}"
          on:MDCChip:interaction={(e) =>
            proxyEvent(e, { ...chip, userId: selectionUserId })}
        >
          <LeadingIcon class="material-icons" leading
            >{getIcon(chip.flag)}</LeadingIcon
          >
