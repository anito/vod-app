<script>
  ...
  import { images, fabs, urls, sitename } from "stores";
...
<div class="lg:p-8">
  {#if $session.user}
    ...
    <div class="flex flex-wrap lg:justify-start justify-center" style="max-width: 80%; flex: 1 0 80%;">
      {#each $images.sort(sortAZ) as image (image.id)}
        <div class="flex flex-1 mx-1 my-2">
