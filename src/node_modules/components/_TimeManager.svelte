<script>
  ...
  import List from "@smui/packages/list";
  import IconButton, { Icon } from "@smui/packages/icon-button";
  import Snackbar, {
    Actions,
    Label as SnackbarLabel,
  } from "@smui/packages/snackbar";
  import Fab, { Label as FabLabel, Icon as FabIcon } from "@smui/packages/fab";
  ...
  function onApplyHandler({ detail }) {
    ...
    saveTime(isoStart, isoEnd, selectionVideoId);
  }

  async function saveTime(start, end, id, e) {
    e && e.stopPropagation();
  ...
  function handleSuccess(res, user) {
    ...
    message = (res.data && res.data.message) || "Success";
    snackbar.open();
  }
  ...
  function handleClosed() {
    isRedirect && goto(`login${redirect($page)}`);
  }
</script>
