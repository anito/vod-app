<script>
  ...
  import Card, { ActionIcons } from "@smui/card";
          ...
          {#each userVideos as video (video.id)}
            <SimpleVideoCard
              ...
              {#if 'Administrator' === $session.role}
                ...
                <Menu bind:this={cardMenu} anchorCorner="TOP_RIGHT">
                  <List>
                    <Item disabled={!video.image_id} on:SMUI:action={() => {}}>
                      <Text>Zum Video gehen</Text>
                    </Item>
                  </List>
                </Menu>
              {/if}
