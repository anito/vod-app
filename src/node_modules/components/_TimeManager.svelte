<script>
  ...
  const timespanSelections = [
    { title: $_('text.1-month'), value: 30 },
    { title: $_('text.-months', { values: { number: 2 } }), value: 60 },
    { title: $_('text.-months', { values: { number: 3 } }), value: 90 },
    { title: $_('text.self-select-timeframe'), value: 'self' },
  ];
          ...
          <div>
            ...
            <div>
              <ul class="reasons-list">
                ...
                {/if}
                {#if isExpired}
                  <li>{$_('text.token-expired')}</li>
                {/if}
                {#if !currentUser.active}
                  <li>{$_('text.user-is-deactivated')}</li>
                {/if}
              </ul>
            </div>
          </div>
