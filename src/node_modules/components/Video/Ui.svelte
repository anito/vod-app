<script>
  ...
  $: percentageBuffer =
    buffered.length && (buffered[buffered.length - 1].end * 100) / duration;
...
<style>
  ...
  * {
  ...
  video[controls]::-webkit-media-text-track-container.visible-controls-bar {
    height: calc(
      100% - var(--inline-controls-bar-height) -
        var(--inline-controls-inside-margin)
    );
  }
...
<div class="media-controls-container">
  ...
  <div
    ...
    {#if isNaN(duration)}
      <button
        class="play-pause center paused"
        ...
        <div
          ...
          <div class="buttons-container" style="">
            <button
              ...
              style="">
              <picture
                style="-webkit-mask-image: url({data_pip}); width: 22px; height: 22px;" />
            </button>
          </div>
        </div>
        <div
          ...
          <div class="buttons-container left" style="flex: 2;">
            <button
              ...
              style="">
              <picture
                style="-webkit-mask-image: url({data_rwd}); width: 13px; height: 17px;" />
            </button>
            <button
              on:click={(e) => dispatch('play-pause', e)}
              ...
              style="">
              <picture
                style="-webkit-mask-image: url({paused ? data_play : data_pause}); width: 11px; height: 13px;" />
            </button>
            <button
              ...
              style="">
              <picture
                style="-webkit-mask-image: url({data_fwd}); width: 13px; height: 17px;" />
            </button>
          </div>
          <div
            class="time-control flex"
            style="flex: 8;"
            ...
            <div
              class="slider scrubber"
              style="flex: 8; height: 16px; width: 100%;">
          ...
          <div class="buttons-container" style="flex: 1;">
            <button
              ...
              style="">
              <picture
                style="-webkit-mask-image: url({data_full}); width: 24px; height: 24px;" />
            </button>
          </div>
        </div>
      </div>
