<script>
  ...
  import { getMedia, hasStarted, isExpired } from 'utils';
  ...
  function _readoutDuration(date, endDate) {
    if (endDate && isExpired(endDate)) return 'text.expired';
...
>
  ...
  <span class="action-buttons flex flex-1 justify-end">
    <slot {expired} published={!emptyDate} {unmanagable} />
  </span>
</Item>
