...
<Media aspectRatio="16x9">
    <MediaContent class="flex" style="display: flex; z-index: 0;">
        <div class="text-wrapper bg-gradient-to-b from-black" class:activeEditor class:isPlaying>
            <h2 class:opacity-25={!media.title} class="mdc-typography--headline6" style="margin: 0;">{media.title || 'No Title'}</h2>
            <h3 class:opacity-25={!media.description} class="mdc-typography--subtitle2" style="margin: 0;">{media.description || 'No Description'}</h3>
        </div>
