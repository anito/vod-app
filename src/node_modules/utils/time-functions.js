...
export function toLocalDate(date, locale = 'de-DE', options = {}) {
  let defaults = {
    year: false,
    month: false, // 2-digit
    day: false,
...
export function toLocalTime(date, locale = 'de-DE', options = {}) {
  let defaults = {
    year: false,
    month: false, // 2-digit
    day: false,
...
export function isToday(date) {
  let today = new Date();
  let midnight =
    today.getTime() - today.getHours() * 3600 * 1000 - today.getMinutes() * 60 * 1000 - today.getSeconds() * 1000;
